...
class JWTLoginSerializer(serializers.Serializer):
    ...
    """
    username = serializers.CharField(max_length=Account._meta.get_field('username').max_length)
    password = serializers.CharField(write_only=True, max_length=Account._meta.get_field('password').max_length)
